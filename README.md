...
- Targets dsh **0.1.0-rc.8** — the tested host version; drift protection is regression coverage (future test-strategy ADR) plus install-time peerDependency ranges — no boot-time version check
