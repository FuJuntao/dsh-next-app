...
export const LABEL = "block break-words text-2xs leading-tight font-medium text-muted-foreground";
export const META = "block break-words text-2xs leading-tight text-muted-foreground";
