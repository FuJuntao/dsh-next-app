...
/**
 * The shell's own SidebarProvider: the single owner of the shell's
 ...
 * (16rem) styles the shell. The layout seeds both from the prefs cookie
 * for the first paint (no flash); the resize handle mutates the width
 * variable in place and persists on release, and every desktop fold
 * toggle persists through updatePreferences.
 */
