...
| [0013](0013-story-planning-no-task-breakdown.md) | Story planning ends at the story — the task breakdown and task issues are dropped (supersedes ADR-0005's task-breakdown clauses) | Accepted |
