 ...
 * 0.1.0-rc.7 (MIT license; deepseek-ai/deepseek-harness,
 * packages/client/connection). Upstream does not export this controller
 * at its package boundary; dsh-api ports it keeping the same
 * ConnectionSinks/ConnectionConfig contract and loop semantics.
 * Differences from upstream: log prefix is [dsh-api] instead of
 * [web-runtime]; coverage annotations dropped.
 */
import type {
  HostFrame,
  MuxFrame,
